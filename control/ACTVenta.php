...
class ACTVenta extends ACTbase{    
   ...
   function listarVentaEmisor( ){
    ...
    function insertarVentaCompleta(){
		...
		//var_dump($datos2);
		//var_dump('1222222222222222222222222222222222'); 
...
class ACTVenta extends ACTbase{    
   ...
   function listarVentaEmisor( ){
    ...
    function insertarVentaCompleta(){
		...
		// $datos = new convert_xml();
		// $k=$datos->array_xml($cabecera->generarJson(),$detalle->generarJson(),$id);


		$datos2 = new convert_xml2("factura_".$id, dirname(__FILE__).'/../archivos_facturacion_xml/');
		$datos2->array_xml($cabecera->generarJson(),$detalle->generarJson(),$id);
		$datos2->llenarSignature();
		$datos2->crearArchivoXML(); 
		// echo ( $datos2->validarXmlConXSD() )? 'SII': 'NOO';
		$datos2->crearArchivoBase64();
		$datos2->crearArchivoGZIP();
		$cadenaBase64GZIP = $datos2->convertirArchivoGZIPABase64();
		$nombreArchivoXml = $datos2->getNombre();
